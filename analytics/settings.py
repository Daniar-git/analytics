...
SECRET_KEY = 'django-insecure-5je(nfcwg05(1&3a0g*btovp&gtff&3*kxi*fq$ec_xxrhrem*'
...
MIDDLEWARE = [
    ...
    'analytics.disabled.DisableCSRF',
...
REST_AUTH = {
    ...
    'REGISTER_SERIALIZER': 'analytics.user.serializers.UserRegistrationSerializer',
    'USE_JWT': False,
}
